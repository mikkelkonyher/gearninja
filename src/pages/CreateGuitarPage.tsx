...
export function CreateGuitarPage() {
  ...
  const handleTouchMove = (e: React.TouchEvent) => {
    ...
    // Find the grid container - try multiple methods for reliability
    let gridContainer = (e.currentTarget as HTMLElement).closest('.grid') as HTMLElement;
    if (!gridContainer) {
      // Fallback: find element at touch point and traverse up
      const elementAtPoint = document.elementFromPoint(touchX, touchY);
      if (elementAtPoint) {
        gridContainer = elementAtPoint.closest('.grid') as HTMLElement;
      }
    }
        ...
        >
          ...
          <div className="mb-8">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">
              {isEditMode ? "Rediger annonce - Guitar" : "Opret annonce - Guitar"}
            </h1>
